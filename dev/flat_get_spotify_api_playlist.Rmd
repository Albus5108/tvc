...
```{r development-query_playlist}
# You can prepare the code of the query_playlist() function here
```
  
```{r function-query_playlist}
#' Query Playlist
#' 
#' Description
#' 
...
```{r example-query_playlist}
query_playlist()
```
  
```{r tests-query_playlist}
