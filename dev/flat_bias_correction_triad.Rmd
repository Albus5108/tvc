...
```{r development-compute_triad_probability_old}
# You can prepare the code of the compute_triad_probability_old() function here
```
  
```{r function-compute_triad_probability_old}
#' Compute Triad Probability (depreciated)
#' 
#' This first method was based on the interval probabilities but is missing finesse in the way it describes the 
#' relationship between the two intervals of the triad.
...
#' 
#' @noRd
compute_triad_probability_old <- function(stat_interval){
...
```{r tests-compute_triad_probability_old}
...
# → On 2026-02-08, 838 songs are worth 91 because of Triad, Space and Time bias.
# → On 2026-02-09, 871 songs are worth 39.2 because of Triad, Space and Time bias.
# → On 2026-02-11, 959 songs are worth 42.1 because of Triad, Space and Time bias.
# → On 2026-02-12, 979 songs are worth 42.8 because of Triad, Space and Time bias.
# → On 2026-02-13, 1015 songs are worth 42.2 because of Triad, Space and Time bias.
# → On 2026-02-15, 1050 songs are worth 102 because of Triad, Space and Time bias.
# → On 2026-02-16, 1091 songs are worth 124.8 because of Triad, Space and Time bias.
# → On 2026-02-17, 1110 songs are worth 137.9 because of Triad, Space and Time bias.
# → On 2026-02-23, 1169 songs are worth 165.3 because of Triad, Space and Time bias.
cli::cli_alert(glue::glue(
  "On ",
  format(Sys.Date(), format = '%Y-%m-%d'), ", ",
  nrow(w_time_space2),
  " songs are worth ",
  round(sum(w_time_space2[["weighted_year_country"]], na.rm = TRUE), digits = 1),
