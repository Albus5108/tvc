---
title: "flat_plot_tvc_network_artist.Rmd empty"
...
# plot_tvc_network_artist

```{r development-plot_tvc_network_artist}
# Prepare the code of your function here
```

```{r function-plot_tvc_network_artist}
...
#'
#' @examples
plot_tvc_network_artist <- function(data) {
  data <- data %>% 
...
```{r examples-plot_tvc_network_artist}
...
print(plot_tvc_network_artist(data))
```

```{r tests-plot_tvc_network_artist}
test_that("plot_tvc_network_artist works", {
  expect_true(inherits(plot_tvc_network_artist, "function"))
})
```
...
fusen::inflate(flat_file = "dev/flat_plot_tvc_network_artist.Rmd", vignette_name = "Go further")
```
